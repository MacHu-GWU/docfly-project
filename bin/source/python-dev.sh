...
reformat_pep8_code_style() {
    ...
    pprint "[pygitrepo] {FORE_CYAN}reformat python code style, execute {STYLE_RESET_ALL}${dir_project_root}/reformat_pep8_code_style.py"
    "${bin_python}" "${dir_project_root}/reformat_pep8_code_style.py"
}
...
clean_doc() {
    ...
    pprint "[pygitrepo] {FORE_CYAN}Clean recently built doc at {STYLE_RESET_ALL}${dir_sphinx_doc_build}"
